...
def calc(capital_aplicado, aporte_mensal, taxa_de_juros, tempo_da_aplicacao ):
    ...
    taxa_de_juros_porcentagem = taxa_de_juros / 100
    montante = (capital_aplicado * ((1+ taxa_de_juros_porcentagem) ** tempo_da_aplicacao  )) + (aporte_mensal * ((((1 + taxa_de_juros_porcentagem) ** tempo_da_aplicacao  )-1) / taxa_de_juros_porcentagem))
    #print(pmt)
    #print(f'{montante:.2f}')
    return montante
